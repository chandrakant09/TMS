...
<body onload="submitPayuForm();">
   ...
   <li>Please do not press "Submit" button once again or the "Back" or "Refresh" buttons</li>
	...
	<div style="display: none">
		<form action="../pym/success" method="post" name="payuFormsuccess">
			...
			<table>
				...
				<tr>
					<td>Tax Id:</td>
					<td><input name="txnid"
						value="<%= (empty(params.get("txnid"))) ? "" : params.get("txnid") %>" /></td>
				</tr>
				<tr>
					<td>USER ID:</td>
					<td><input name="User ID"
						value="<%= (empty(params.get("udf1"))) ? "" : params.get("udf1") %>" /></td>
				</tr>
				<tr>
					<td>E Distric Id :</td>
					<td><input name="E Distt Id"
						value="<%= (empty(params.get("udf2"))) ? "" : params.get("udf2") %>" /></td>
				</tr>
